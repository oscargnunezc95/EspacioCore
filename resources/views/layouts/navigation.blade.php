...
<div x-data="{ 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden xl:ml-10 xl:flex xl:items-center xl:space-x-2">
                        ...
                        @auth
                            ...
                            <a href="{{ route('global.classes.teacher') }}" class="inline-flex items-center gap-1.5 px-4 py-3.5 border-b-2 text-sm transition-all duration-200 {{ $isTeacherActive ? $desktopActive : $desktopInactive }}">
    ...
    <div x-show="mobileMenuOpen" 
         ...
         class="fixed inset-0 bg-zinc-900/60 z-50 xl:hidden pointer-events-auto" 
         style="display: none;"></div>

    {{-- Cajón Deslizante --}}
    <div :class="{'translate-x-0': mobileMenuOpen, '-translate-x-full': !mobileMenuOpen}" 
         class="-translate-x-full fixed inset-y-0 left-0 z-[60] w-4/5 max-w-sm bg-white shadow-2xl transition-transform duration-300 ease-in-out flex flex-col xl:hidden transform pointer-events-auto" x-cloak>
