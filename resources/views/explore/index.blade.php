...
>
    ...
    <div class="relative min-h-screen overflow-hidden">
        ...
        {{-- ============================================================ --}}
        {{-- SIDEBAR FIJO (Desktop: lg+) — Fuera del contenedor principal --}}
        {{-- ============================================================ --}}
        <aside class="hidden lg:block fixed left-0 top-0 h-full w-72 z-30 overflow-y-auto bg-white border-r border-red-100/50 pt-24 pb-8 px-5 shadow-sm">
                    ...
                    @forelse($sessions as $session)
                        ...
                        <div class="relative bg-white/80 rounded-3xl overflow-hidden flex flex-col transform-gpu isolate transition-all duration-500 ease-out {{ $isFull ? 'bg-stone-50/80 opacity-75' : 'holo-white-card group/card cursor-pointer' }}">
                            @php
                                ...
                                // 🚀 SOLUCIÓN INFALIBLE POR COORDENADAS: Taller -> Estudio -> Texto
        ...
        @php
            ...
            // 1. Extraer estudios únicos de las sesiones actuales
        ...
        <script>
            ...
            function openDetailModal(data) {
                ...
                // 🚀 CORREGIDO: Lógica infalible de enlace a Google Maps por coordenadas
