...
<div class="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
    <div class="prose prose-zinc max-w-none">
        <h1 class="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-900">Política de Privacidad</h1>
        <p class="text-sm text-zinc-500 mt-2">Última actualización: 20 de junio de 2026</p>

        <hr class="my-8 border-zinc-200">

        <h2 class="text-xl font-semibold text-zinc-800">1. Responsable del Tratamiento</h2>
        <p>
        ...
        <h2 class="text-xl font-semibold text-zinc-800">2. Datos que Recopilamos</h2>
        ...
        <h2 class="text-xl font-semibold text-zinc-800">3. Finalidad del Tratamiento</h2>
        ...
        <h2 class="text-xl font-semibold text-zinc-800">4. Base Legal del Tratamiento</h2>
        <p>
        ...
        <h2 class="text-xl font-semibold text-zinc-800">5. Derechos del Titular (ARCO)</h2>
        ...
        <h2 class="text-xl font-semibold text-zinc-800">6. Conservación de los Datos</h2>
        <p>
        ...
        <h2 class="text-xl font-semibold text-zinc-800">7. Medidas de Seguridad</h2>
        <p>
        ...
        <h2 class="text-xl font-semibold text-zinc-800">8. Transferencias Internacionales</h2>
        <p>
        ...
        <h2 class="text-xl font-semibold text-zinc-800">9. Consentimiento Informado</h2>
        <p>
        ...
        <h2 class="text-xl font-semibold text-zinc-800">10. Contacto</h2>
        <p>
            Para ejercer tus derechos o resolver dudas sobre esta política, contáctanos a través de
            nuestro <a href="{{ route('support.create') }}" class="text-indigo-600 hover:text-indigo-700 transition-colors duration-200 underline decoration-indigo-200 underline-offset-4">formulario de soporte</a>.
        </p>
    </div>
</div>
</x-guest-layout>
